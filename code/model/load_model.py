...
def load_model_and_tokenizer(model_id, device_string, quantization_bits=4):
    ...
    model = AutoModelForCausalLM.from_pretrained(model_id,  device_map={"": device_string}, torch_dtype=torch.float32, quantization_config=quantization_config, trust_remote_code=True)
